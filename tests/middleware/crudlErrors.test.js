...
describe('Throws correct errors', () => {
    ...
    it('Throws authorization error', () =>
        errors(fail(401, {}))
            .read()
            .catch(error => expect(error.authorizationError).toBe(true)))

    it('Throws permission error', () =>
        errors(fail(403, {}))
            .update()
            .catch(error => expect(error.permissionError).toBe(true)))

    it('Throws default error', () =>
        errors(fail(500, {}, 'Server down!'))
            .delete()
            .catch(error => {
